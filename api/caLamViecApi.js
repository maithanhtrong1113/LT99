...
export const getAllCaLamViec = async () => {
  const response = await fetch(
    `https://nhathuoclt99pharmacity.click/quan-ly/ca-lam-viec/`
  );
...
export const xoaCaLamViec = async (id) => {
  const res = await fetch(
    `https://nhathuoclt99pharmacity.click/quan-ly/ca-lam-viec/${id}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
export const chinhSuaCaLamViec = async (data) => {
  const response = await fetch(
    `https://nhathuoclt99pharmacity.click/quan-ly/ca-lam-viec/${data.maCaLam}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
