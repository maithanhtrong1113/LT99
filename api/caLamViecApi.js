...
export const getAllCaLamViec = async () => {
  const response = await fetch(
    `https://khoaluanquanlynhathuoclt99.lol/quan-ly/ca-lam-viec/`
  );
...
export const xoaCaLamViec = async (id) => {
  const res = await fetch(
    `https://khoaluanquanlynhathuoclt99.lol/quan-ly/ca-lam-viec/${id}`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
export const chinhSuaCaLamViec = async (data) => {
  const response = await fetch(
    `https://khoaluanquanlynhathuoclt99.lol/quan-ly/ca-lam-viec/${data.maCaLam}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
